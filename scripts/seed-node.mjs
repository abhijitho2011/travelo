...
const ADMINS = [
  { email: process.env.SEED_SUPER_ADMIN_EMAIL ?? 'admin@travelo.local', name: 'Super Admin', roleKey: 'super_admin', password: process.env.SEED_SUPER_ADMIN_PASSWORD ?? 'ChangeMe!12345' },
