...
final locationsProvider = FutureProvider<Map<String, List<String>>>((ref) async {
  try {
    final remote = await ref.watch(ownerRepositoryProvider).locations();
    if (remote.isNotEmpty) return remote;
  } catch (_) {/* fall through to bundled asset */}
  final raw = await rootBundle.loadString('assets/data/in_states_districts.json');
